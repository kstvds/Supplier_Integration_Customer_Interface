...
public class Book_Credit_Card_DeadLine_Flag_Set {
	...
	public void BookCreditCardDeadlineFlagset(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In.jpg");

		} catch (Exception e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In.jpg";
		...
		try {
			...
			if (elementval.equals("has-switch switch-animate switch-off")) {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath()
						+ "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Before-Flag-Update.jpg");
				driverqa.findElement(Others.Updatechannel).click();
				Thread.sleep(2000);
				obj.Takesnap(driverqa,
						Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Flag-Set.jpg");
			...
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Flag-Setting.jpg";
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Flag-Setting.jpg");
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In-CI.jpg");
		}

		catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In-CI.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Log-In-CI.jpg";
			logger.info(e.getMessage());
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			test.log(LogStatus.INFO, "Starting Hotel Book Credit Card with Deadline flag set");
			logger.info("Starting Hotel Book Credit Card with Deadline flag set");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/MultiRoom.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Unable-To-book-MultiRoom.jpg");
			...
			test.log(LogStatus.INFO, "Ending Hotel Book Credit Card with Deadline flag set");
			test.log(LogStatus.PASS, "Hotel Book Credit Card with Deadline flag set");
			logger.info("Hotel Booked Credit Card with Deadline flag set");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Credit Card with Deadline flag set");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Unable-To-book-MultiRoom.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_DeadLine_Flag_Set/Unable-To-book-MultiRoom.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
