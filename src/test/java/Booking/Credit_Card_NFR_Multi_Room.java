...
public class Credit_Card_NFR_Multi_Room {
	...
	Logger logger = Logger.getLogger("Credit_Card_NFR_Multi_Room");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void CreditCardBookNFRMultiRoom(String browsername) throws Exception {
		test = rep.startTest("Credit Card NFR Multi Room");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_NFR_Multi_Room/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_NFR_Multi_Room/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_NFR_Multi_Room/Log-In.jpg";
		...
		try {
			...
			logger.info("Starting HotelSearch Credit Card NFR Multi Room");
			test.log(LogStatus.INFO, "Starting HotelSearch Credit Card NFR Multi Room");
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_NFR_Multi_Room/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_NFR_Multi_Room/Search-Result.jpg");
			String actualresult = driverqa.findElement(Search.NoRoomsAvailable).getText();
			Assert.assertTrue(actualresult.contains(expectedresult));
			test.log(LogStatus.INFO, "Ending HotelSearch Credit Card NFR Multi Room");
			test.log(LogStatus.PASS, "PASSED HotelSearch Credit Card NFR Multi Room");
			logger.info("Hotel Search Complete Credit Card NFR Multi Room");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Credit Card NFR Multi Room");

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_NFR_Multi_Room/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_NFR_Multi_Room/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
