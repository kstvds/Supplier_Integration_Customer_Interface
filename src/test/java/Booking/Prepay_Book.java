		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			Assert.assertTrue(false, e.getMessage());
	           ...
	           try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay/Booking.jpg");
				errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay/Booking.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
