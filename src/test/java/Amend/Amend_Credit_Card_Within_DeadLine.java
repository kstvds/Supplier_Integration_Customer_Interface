...
######  Scenario Logs In, Books a specified hotel within DeadLine and amends the booking ##### */
...
public class Amend_Credit_Card_Within_DeadLine {
	...
	public void CreditCardAmendWithinDeadline(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Log-In.jpg";
		...
		try {
			 ...
			 * Noofchilds.clear(); Noofchilds.sendKeys("01");
			 */
			/*
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Filters.jpg");
			...
			logger.info("Hotel Search Complete Credit Within Card DeadLine");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Credit Card Within DeadLine");

			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Payment-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Changed-Dates.jpg");
			...
			driverqa.findElement(Amend.AcceptAmendCharge).click();
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Amend-Confirmation-Page.jpg");
			test.log(LogStatus.INFO, "Confirming Changes");
			logger.info("Confirming Changes");
			driverqa.findElement(Amend.ConfirmChanges).click();
			test.log(LogStatus.INFO, "Entering Payment details for amendment");
			wait.until(ExpectedConditions.visibilityOfElementLocated(PaymentPage.AcceptTerms));
			driverqa.findElement(PaymentPage.AcceptTerms).click();
			logger.info("Entered Payment details for amendment");
			test.log(LogStatus.INFO, "Entered Payment details for amendment");
			test.log(LogStatus.PASS, "Payment details for amendment");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Payment-Details-Amend-Charge.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Amend-Confirmed1.jpg");
			JavascriptExecutor js = (JavascriptExecutor) driverqa;
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Card_Within_DeadLine/Amend-Confirmed2.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Amending.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Card_Within_DeadLine/Amending.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
