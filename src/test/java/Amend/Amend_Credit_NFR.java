...
public class Amend_Credit_NFR {
	...
	public void CreditAmendNFR(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Search-Result.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Payment-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_NFR/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_NFR/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_NFR/Can't-Amend-NFR-Rates.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_NFR/Amending.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_NFR/Amending.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
