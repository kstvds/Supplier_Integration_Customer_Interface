...
public class Credit_Card_Amend {
	...
	Logger logger = Logger.getLogger("Credit_Card_Amend");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void CreditCardAmend(String browsername) throws Exception {
		test = rep.startTest("Credit Card Amend");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Payment-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Booking-Details2.jpg");
		...
		try {
			...
			for (WebElement ele : allDates) {
				...
				if (date.equalsIgnoreCase(excel.getData(0, 53, 1))) {
					ele.click();
					break;
				}
			...
			for (WebElement ele : allDates2) {
				...
				if (date.equalsIgnoreCase(excel.getData(0, 53, 2))) {
					ele.click();
					break;
				}
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Changed-Dates.jpg");
			...
			ExpectedAmendDateChkIn = excel.getData(0, 53, 1);
			ExpectedAmendDateChkOut = excel.getData(0, 53, 2);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Amend-Confirmation-Page.jpg");
			...
			ExpectedAfterAmendDateChkIn = excel.getData(0, 53, 1);
			ExpectedAfterAmendDateChkOut = excel.getData(0, 53, 2);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Amend-Confirmed1.jpg");
			JavascriptExecutor js = (JavascriptExecutor) driverqa;
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Card/Amend-Confirmed2.jpg");
