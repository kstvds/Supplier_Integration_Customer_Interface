...
public class Cancel_Credit_Card_NFR {
	...
	public void CreditCardCancelNFR(String browsername) throws Exception {
		...
		try {
			 ...
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Search-Result.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Payment-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_Card_NFR/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_Card_NFR/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_Card_NFR/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		test.log(LogStatus.INFO, "Verifying Non-Clickable Cancel Button");
		logger.info("Verifying Non-Clickable Cancel Button");

		/*
		 * ####### Checking if Cancel Button is Clickable for NFR rate #########
		 **/
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(Cancel.UnableToCancelNFR));
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
			...
			logger.info("Verifed Non-Clickable Cancel Button");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Cancel Credit Card NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_Card_NFR/Amending.jpg");
			errorpath = Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_Card_NFR/Amending.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
