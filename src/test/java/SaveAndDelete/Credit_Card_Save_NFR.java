...
public class Credit_Card_Save_NFR {
	...
	Logger logger = Logger.getLogger("Credit_Card_Save_NFR");
	String errorpath;
	String Roomtype;
	 @Test
	 @Parameters({ "browsername" })
	  public void CreditCardSaveNFR(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			Assert.assertTrue(false, e.getMessage());
	           ...
	           try {
				   ...
				   driverqa.findElement(Search.nextmnth).click();
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(Search.CalenderIN));
					   ...
					   //driverqa.findElement(Search.nextmnth).click();
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Filters.jpg");
					    String expectedresult=excel.getData(0, 9, 1);
	                     ...
	                     Thread.sleep(2000);
						 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Search-Result.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Search-Result.jpg");
	           ...
	           try {
				test.log(LogStatus.INFO, "Starting Hotel Save Itenary");
				   ...
				   wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.OnePaxFirstName));
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Passenger-Details.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Itn-Cart.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Deleted-from-Cart.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Itn-Save.jpg");
				errorpath=Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Itn-Save.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
