	 ...
	 @Parameters({ "browsername" })
	  public void CreditCardSave(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath=Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card/Log-In.jpg";
			...
			Assert.assertTrue(false, e.getMessage());
	           ...
	           try {
				   ...
				   driverqa.findElement(Search.nextmnth).click();
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(Search.CalenderIN));
					   ...
					   //driverqa.findElement(Search.nextmnth).click();
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card/Filters.jpg");
				...
				errorpath=Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
	           ...
	           try {
				test.log(LogStatus.INFO, "Starting Hotel Save 1st Itenary");
				   ...
				   wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.OnePaxFirstName));
					...
					wait.until(ExpectedConditions.elementToBeClickable(Booking.ConfirmBook));
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card/Itn-Cart.jpg");
                    
					wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.AfterSaveHotel));
					...
					test.log(LogStatus.PASS, "Hotel Saved 1st Itenary");
					logger.info("Hotel Saved");
		/*			driverqa.findElement(Booking.CloseCart).click();
					test.log(LogStatus.INFO, "Starting Hotel Save 2nd Itenary");
					   logger.info("Starting Hotel Save 2nd");
					   Thread.sleep(2000);
					   wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.Bookroom));
					   test.log(LogStatus.INFO, "Selecting Room");
					   logger.info("Selecting Room");
					   ...
					   wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.OnePaxFirstName));
						...
						Thread.sleep(2000);
						driverqa.findElement(Booking.OnePaxlastName).sendKeys(excel.getData(0, 21, 2));
						Select passengertitle5 = new Select(driverqa.findElement(Booking.OnePaxTitle));
						passengertitle5.selectByIndex(1);
						driverqa.findElement(Booking.TwoPaxFirstName).sendKeys(excel.getData(0, 22, 1));
						Thread.sleep(1000);
						driverqa.findElement(Booking.TwoPaxLastName).sendKeys(excel.getData(0, 22, 2));
						Select passengertitle3 = new Select(driverqa.findElement(Booking.TwoPaxTitle));
						...
						wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.AfterSaveHotel2));
						String expectedaftrsavehotel2 = excel.getData(0, 9, 1);
						String actualaftrsavehotel2 = driverqa.findElement(Booking.AfterSaveHotel2).getText();
						Assert.assertTrue(actualaftrsavehotel2.contains(expectedaftrsavehotel2));
						test.log(LogStatus.PASS, "Hotel Saved 2nd Itenary");
						logger.info("Hotel Saved");*/
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card/Deleted-from-Cart.jpg");
				...
				test.log(LogStatus.FAIL, "Hotel Save Credit Card");
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card/Itn-Save.jpg");
				errorpath=Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card/Itn-Save.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
