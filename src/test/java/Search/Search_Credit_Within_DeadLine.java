	  ...
	  public void SearchCreditWithinDeadLine(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_DeadLine/Log-In.jpg");

		} catch (Exception e) {
			
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Within_DeadLine/Log-In.jpg");
				   ...
				   driverqa.findElement(Search.nextmnth).click();
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(Search.CalenderIN));
					   ...
					   //driverqa.findElement(Search.nextmnth).click();
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_DeadLine/Filters.jpg");
						 ...
						 Thread.sleep(2000);
						 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_DeadLine/Search-Result.jpg");
						 ...
						 logger.info("Hotel Search Complete c Within DeadLine");
			} catch (Exception e) {
